...
function CubesHaveFeelingsToo() { //x2
...
export function getGelCubeDeck() {
    return [
        CombatCubed(), CombatCubed(), CombatCubed(),
        D6OfDoom(), D6OfDoom(),
        ClericALaSlime(), ClericALaSlime(),
        ArcaneAppetizer(), ArcaneAppetizer(),
        FastestCubeAlive(), FastestCubeAlive(), FastestCubeAlive(),
        AcidBurp(), AcidBurp(),
        SlimeTime(), SlimeTime(),
        CubesHaveFeelingsToo(), CubesHaveFeelingsToo(),
        OpenWide(),
        SugarRush(), SugarRush(),
        FormerFriends(),
        Hugs(), Hugs(),
        HereICome(), HereICome(),
        BurpedUpBones(), BurpedUpBones(),
    ];
}
